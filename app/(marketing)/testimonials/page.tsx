...
export const metadata: Metadata = {
  ...
  description: 'Read reviews from happy parents, schools, and corporate clients who chose Your Very Own Bounce House Party Rental for their DFW events.',
};
...
export default function TestimonialsPage() {
  const allTestimonials = [
    ...
    { name: "Jessica Ramirez", role: "School Fest Coordinator", text: "Your Very Own Bounce House Party Rental provided 5 inflatables for our school festival. Their insurance process was seamless and they handled the massive crowd with ease. Best vendor we have worked with." },
    ...
    { name: "Thomas Wilson", role: "Neighborhood HOA", text: "We do an annual block party and Your Very Own Bounce House Party Rental is our go-to. Their generators are quiet and reliable." },
    ...
    { name: "Andrew White", role: "Dad", text: "Cleanest inflatables in DFW. I've used others that smelled like mildew, but Your Very Own Bounce House Party Rental treats their equipment right." },
    ...
    { name: "Isabella Clark", role: "Event Planner", text: "I require COI (Certificate of Insurance) for all my vendors. Your Very Own Bounce House Party Rental had theirs over to me within an hour. True professionals." },
    ...
    <>
      <div className="container mx-auto px-4 py-20 max-w-7xl">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-600 mb-8 leading-relaxed">Don't just take our word for it. Read what local parents, event planners, and business owners have to say about their experience with Your Very Own Bounce House Party Rental.</p>
