      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4 md:grid-cols-2 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block">
              <Image src="/logo-slide.png" alt="Your Very Own Bounce House Party Rental" width={140} height={48} className="h-12 w-auto brightness-0 invert" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-400">bouncehousepartyrentals64@gmail.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            &copy; {new Date().getFullYear()} Your Very Own Bounce House Party Rental. All rights reserved.
          </p>
