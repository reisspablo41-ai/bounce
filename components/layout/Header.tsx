...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/50 bg-white/60 backdrop-blur-3xl shadow-sm shadow-primary-500/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center">
              <Image src="/logo-slide.png" alt="Your Very Own Bounce House Party Rental" width={140} height={48} className="h-12 w-auto" priority />
            </Link>
          </div>
